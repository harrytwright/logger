...
const getEnv = (env) =>
  process.env[`REACT_APP_${env}`] || process.env[env]
...
/* istanbul ignore next */
const isTest = () => getEnv('__testing_override') != null
  ? false
...
function Log (app = 'logger', level = 'info') {
  ...
  internalSlotsMap.set(this, /* istanbul ignore next */ {
...
/**
 * @param {"app"|"level"|"stream"|"maxRecordSize"|"redact"} key
 * @returns any
 * */

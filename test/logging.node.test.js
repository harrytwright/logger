...
describe("redaction", function () {
  ...
  it("should work with a default redaction", function () {
    ...
    log.verbose(
      ...
      "demo %s",
      "https://password:password@example.com:3000",
    );
  ...
  it("should work w/ multiple redactions", function () {
    ...
    log.info(
      "demo",
      "binary output for 5 is %s and %s with %s",
      10,
      10,
      "https://password:password@example.com:3000",
    );
    ...
    const record = log.record.pop();
    expect(record.message).to.be.eq(
      "binary output for 5 is 1010 and 1010 with https://********@example.com:3000/",
    );
  });
});
